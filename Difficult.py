...
rock2_img = pygame.image.load(os.path.join("image", "rock2.png")).convert()
rock3_img = pygame.image.load(os.path.join("image", "rock3.png")).convert()
...
class Rock2(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = rock2_img
        self.image = pygame.transform.scale(rock2_img, (30, 12))
        self.image.set_colorkey(WHILT)
        self.rect = self.image.get_rect()
        self.rect.x = 0
...
class Rock3(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = rock3_img
        self.image = pygame.transform.scale(rock3_img, (30, 12))
        self.image.set_colorkey(WHILT)
        self.rect = self.image.get_rect()
        self.rect.x = WIDTH
        self.rect.y = random.randint(0, HEIGHT)
